...
-- Name: FKI__IMAGES__ARTICLES; Type: INDEX; Schema: conduit_db; Owner: postgres
--
...
-- Name: FK__ARTICLES__BOOKS; Type: FK CONSTRAINT; Schema: conduit_db; Owner: postgres
--
...
-- Name: FK__IMAGES__ARTICLES; Type: FK CONSTRAINT; Schema: conduit_db; Owner: postgres
--
