...
(function (window) {
	...
	window.__config.MAX_DAYS_BACK = 1; //Will delete anything older than this many days, and will cap the filter at this many days
	window.__config.DEFAULT_DAYS_BACK = 1;
